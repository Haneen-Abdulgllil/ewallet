...
<body>
    <div class="container">
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav class="d-inline-flex mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 text-dark text-decoration-none btn btn-primary btn-sm" href="shop.php">Home</a>
        ...
        <form action="viewCart.php" method="post">
            <label for="" >The total price is <?php echo  $total; ?> </label>
            <button class="btn fw-bold my-2 btn-primary m-5" name="pay" type="submit">Pay </button>
        </form>   
    </div>
    <?php 
...
if(isset($_POST['pay'])){
    if(!($total > $balance)){
        ...
        $id = $_SESSION['id'];
        $sql = "UPDATE trans SET amount = $Amount WHERE to_user_id = $id";
        echo $Amount." Amount";
